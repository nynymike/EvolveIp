...
class PersonAuthentication(PersonAuthenticationType):
    ...
    def getApiVersion(self):
        print "======3 getApiVersion"
        return 1

    def isValidAuthenticationMethod(self, usageType, configurationAttributes):
        print "======4 isValidAuthenticationMethod"
        return True

    def getAlternativeAuthenticationMethod(self, usageType, configurationAttributes):
        print "======5 getAlternativeAuthenticationMethod"
        return None

    def getUserValueFromAuth(self, remote_attr, requestParameters):
        print "======6 getUserValueFromAuth"
        try:
    ...
    def prepareForStep(self, configurationAttributes, requestParameters, step):
        print "======8 prepareForStep --"               
        if (step == 1):
            identity = CdiUtil.bean(Identity)
            sessionId =  identity.getSessionId()
            sessionAttribute = sessionId.getSessionAttributes()
            print "snehal shah idp prepareForStep", sessionAttribute.get("state")
            print "-----------------------------------------"
            redirectTo = sessionAttribute.get("state")
    ...
    def getExtraParametersForStep(self, configurationAttributes, step):
        print "======9 getExtraParametersForStep"
        return None

    def getCountAuthenticationSteps(self, configurationAttributes):
        print "======10 getCountAuthenticationSteps"
        return 1
	
    def getPageForStep(self, configurationAttributes, step):
        print "======11 getPageForStep --"
        if (step == 1):
    ...
    def prepareAttributesMapping(self, remoteAttributesList, localAttributesList):
        print "======13 prepareAttributesMapping"
        try:
